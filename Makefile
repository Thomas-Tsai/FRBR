# This Makefile is for the FRBR::Entry extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/FRBR/Entry.pm]
#     AUTHOR => [q[thomas <thomas@>]]
#     BUILD_REQUIRES => {  }
#     CONFIGURE_REQUIRES => {  }
#     DEFINE => q[]
#     INC => q[-I.]
...
#     PREREQ_PM => {  }
#     TEST_REQUIRES => {  }
#     VERSION_FROM => q[lib/FRBR/Entry.pm]
...
INSTALLSITELIB = $(SITEPREFIX)/share/perl/5.18.1
DESTINSTALLSITELIB = $(DESTDIR)$(INSTALLSITELIB)
INSTALLVENDORLIB = $(VENDORPREFIX)/share/perl5
DESTINSTALLVENDORLIB = $(DESTDIR)$(INSTALLVENDORLIB)
INSTALLARCHLIB = $(PERLPREFIX)/lib/perl/5.18
DESTINSTALLARCHLIB = $(DESTDIR)$(INSTALLARCHLIB)
INSTALLSITEARCH = $(SITEPREFIX)/lib/perl/5.18.1
...
PARENT_NAME = FRBR
DLBASE = $(BASEEXT)
VERSION_FROM = lib/FRBR/Entry.pm
INC = -I.
DEFINE = 
...
INST_LIBDIR      = $(INST_LIB)/FRBR
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/FRBR
...
TO_INST_PM = lib/FRBR/CMARC.pm \
	lib/FRBR/Entry.pm \
	lib/FRBR/MARC21.pm

PM_TO_BLIB = lib/FRBR/CMARC.pm \
	blib/lib/FRBR/CMARC.pm \
	lib/FRBR/MARC21.pm \
	blib/lib/FRBR/MARC21.pm \
	lib/FRBR/Entry.pm \
	blib/lib/FRBR/Entry.pm
...
XSPROTOARG = 
XSUBPPDEPS = /usr/share/perl/5.18/ExtUtils/typemap $(XSUBPP)
...
# FRBR::Entry might depend on some other libraries:
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW) \
	  lib/FRBR/MARC21.pm $(INST_MAN3DIR)/FRBR::MARC21.$(MAN3EXT) \
	  lib/FRBR/Entry.pm $(INST_MAN3DIR)/FRBR::Entry.$(MAN3EXT) \
	  lib/FRBR/CMARC.pm $(INST_MAN3DIR)/FRBR::CMARC.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'abstract: '\''Perl extension for FRBR Disply'\''' >> META_new.yml
	$(NOECHO) $(ECHO) 'author:' >> META_new.yml
	$(NOECHO) $(ECHO) '  - '\''thomas <thomas@>'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'name: FRBR-Entry' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   "abstract" : "Perl extension for FRBR Disply",' >> META_new.json
	$(NOECHO) $(ECHO) '   "author" : [' >> META_new.json
	$(NOECHO) $(ECHO) '      "thomas <thomas@>"' >> META_new.json
	$(NOECHO) $(ECHO) '   ],' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "FRBR-Entry",' >> META_new.json
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Perl extension for FRBR Disply</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>thomas &lt;thomas@&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/FRBR/CMARC.pm blib/lib/FRBR/CMARC.pm \
	  lib/FRBR/MARC21.pm blib/lib/FRBR/MARC21.pm \
	  lib/FRBR/Entry.pm blib/lib/FRBR/Entry.pm 
